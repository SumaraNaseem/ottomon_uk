...
// setPId(parts[1])
          ...
          setname(response.data.sales.name); // Set the fetched price
          setdescription(response.data.sales.description); // Set the fetched price
          setinStock(response.data.sales.countInStock); // Set the fetched price
          setinimageUrl(response.data.sales.imageUrl); // Set the fetched price
          setPId(response.data.sales)
        } catch (error) {
