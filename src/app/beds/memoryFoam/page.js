        ...
        <div className="">
            <div>
                <div className="products-banner bg-gray-500 flex justify-center p-20">
                    <div className="text-white text-xl">Beds and Bed Frames</div>
                </div>
                <div className="products-body px-10 mt-5 py-5">
                            ...
                            <div className="drawer-content">
                                <label htmlFor="my-drawer" className="drawer-button">
                                    <div className="filter flex gap-0.5 text-gray-400 ">
                                        <span>
                                            <svg className="mt-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="16" height="16">
                    ...
                    <div className="list">
                        <ProductListBeds CallingFrom='memoryFoam' selectedGrid={selectedGrid} setSelectedGrid={setSelectedGrid} />
                    </div>
