        ...
        <div className="">
            ...
            <div>
                ...
                <div className="products-body px-10 mt-5 py-5 ">
                    ...
                    <div className="list">
                        <ProductListBeds CallingFrom='CutBedMattresses'  selectedGrid={selectedGrid} setSelectedGrid={setSelectedGrid} />
                    </div>
...
export default CutBedMattresses;
