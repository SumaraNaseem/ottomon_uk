        ...
        const fetchMattresses = async () => {
          try {
            ...
            const filters = {
              ...
              CutBedMattresses: 'Cut Bed Mattresses',
              KidsMattresses: 'Kids Mattresses',
              NextDayMattresses: 'Next Day Mattresses',
              SuperKingsBeds: `Super Kings Beds(6')`,
              KingSizeBeds: `King Size Beds(5')`,
              DoubleBeds :`Double Beds(4' 6'')`,
          ...
          selectedGrid === 0 ? (
              ...
              <div className="flex items-center flex-wrap justify-between w-full ">
                {!isMattresses && (
                  <div className="text-center pt-3">
                    <a onClick={() => {
                  router.push(`/beds/${item._id}`);}} className="bg-primary cursor-pointer p-3 px-2 xs:ms-[0px] ms-[6px] text-white rounded-md">
                ...
                <div className="px-4 py-3">
                  ...
                  <div className="flex items-center">
                    ...
                    {/* <button className="add-to-cart m-2 btn btn-default bg-primary text-white"
            ...
            <div key={item._id} className="min-w-full min-h-full bg-white shadow-md rounded-xl  hover:shadow-xl overflow-hidden">
              ...
              <div className="text-center pt-3">
                {!isMattresses && (
                  <a onClick={() => {
                    router.push(`/beds/${item._id}`);}} className="byb-badge cursor-pointer">
                    <span>Customize your bed</span>
                  </a>
                )}
              </div>
