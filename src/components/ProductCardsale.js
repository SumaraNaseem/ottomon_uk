          ...
          selectedGrid === 0 ? (
              ...
              <div className="flex items-center flex-wrap justify-between w-full ">
                {!isMattresses && (
                  <div className="text-center pt-3">
                    <a onClick={() => {
                  router.push(`/mattresses/${item._id}`);}} className="bg-primary cursor-pointer p-3 px-2 xs:ms-[0px] ms-[6px] text-white rounded-md">
            ...
            <div key={item._id} className="min-w-full min-h-full bg-white shadow-md rounded-xl  hover:shadow-xl overflow-hidden">
              ...
              <div className="text-center pt-3">
                {!isMattresses && (
                  <a onClick={() => {
                  router.push(`/sales/${item._id}`);
                }
                
                }
                    // ssss.push(`/products/slug/${item._id}`) }}
