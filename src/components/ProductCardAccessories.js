              ...
              <div className="flex items-center flex-wrap justify-between w-full ">
                {!isMattresses && (
                  <div className="text-center pt-3">
                    <a onClick={() => {
                  router.push(`/accessories/${item._id}`);}} className="bg-primary cursor-pointer p-3 px-2 xs:ms-[0px] ms-[6px] text-white rounded-md">
            ...
            <div key={item._id} className="min-w-full min-h-full bg-white shadow-md rounded-xl  hover:shadow-xl overflow-hidden">
              <div className="overflow-hidden relative">
                ...
                <img
                    src={item.imageUrl}
                    alt="Product"
                    className=" object-contain h-[auto] w-[120%] rounded-t-xl duration-1000 hover:scale-125"
                    ref={imageRef}
                  />
              </div>
              <div className="text-center pt-3">
                {!isMattresses && (
                  <a onClick={() => {
                    router.push(`/accessories/${item._id}`);}} className="byb-badge cursor-pointer">
                    <span>Customize your bed</span>
                  </a>
                )}
              </div>
